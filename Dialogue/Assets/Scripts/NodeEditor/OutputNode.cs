...
public class OutputNode : BaseNode {
    ...
    public override void DrawWindow()
    {
        ...
        if (inputNode)
        {
            input1Title = inputNode.GetResult(); // Value of attached inputNode
        }
        ...
        {
            inputNodeRect = GUILayoutUtility.GetLastRect(); // Window of inputNode
        }
    ...
    public override BaseInputNode ClickedOnInput(Vector2 pos)
    {
        ...
        // Converts global input position to local input position
        pos.x -= windowRect.x;
        pos.y -= windowRect.y;
