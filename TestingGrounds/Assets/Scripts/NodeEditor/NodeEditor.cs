...
public class NodeEditor : EditorWindow {
    ...
    public void DisplayInteractables(int index, Rect windowRect)
    {
        ...
        {
            isActive = true;
            windows = interactableList.interactables[index].script.Windows;
            if (windows.Count == 0)
            {
                if (interactableList.interactables[index].script.Windows.Count == 0)
                {
            ...
            if (GUI.Button(new Rect(5, 0, 100, 20), "Save"))
            {
                ...
                windows = interactableList.interactables[index].script.SaveDialogue(windows);
            }
        }
    ...
    void GetPreviousDialogue(int index)
    {
        ...
        if (interactableList.interactables[index].script.dialogue.sentences.Count != 0)
        {
            ...
            interactableList.interactables[index].script.Windows.Add(prevDialogue);
        }

        if (interactableList.interactables[index].script.dialogue.choices.Length != 0)
        {
            ...
            {
                prevChoices.NumChoices = interactableList.interactables[index].script.dialogue.choices.Length;
            ...
            interactableList.interactables[index].script.Windows.Add(prevChoices);
            ...
            for (int i = 0; i < interactableList.interactables[index].script.dialogue.altDialogue.Count; i++)
            {
                ...
                interactableList.interactables[index].script.Windows.Add(followUps);
            }
        }
    }
}
